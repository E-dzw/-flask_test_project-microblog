...
def user(username):
    ...
    posts=[
        {'author': usr, 'body': 'post test #1'},
        {'author': usr, 'body': 'post test #2'}
    ]
    return render_template('user.html',user=usr,posts=posts,title=usr.username)
